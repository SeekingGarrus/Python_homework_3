...
choice = int(input('Введите 0, если играем в английской раскладке, либо 1, если в русской: '))
eng = {1:'AEIOULNSTR', 2:'DG', 3:'BCMP', 4:'FHVWY', 5:'K', 8:'JX', 10:'QZ'}
rus = {1:'АВЕИНОРСТ', 2:'ДКЛМПУ', 3:'БГЁЬЯ', 4:'ЙЫ', 5:'ЖЗХЦЧ', 8:'ШЭЮ', 10:'ФЩЪ'}
word = input('Введите слово: ').upper()
if choice == 0:
	print(f"Кол-во очков: {sum([k for i in word for k, v in eng.items() if i in v])}")
elif choice == 1:
	print(f"Кол-во очков: {sum([k for i in word for k, v in rus.items() if i in v])}")